        ...
        <div className="py-8 sm:py-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                Testez vos connaissances avec 12 quiz soigneusement sélectionnés couvrant l'algèbre,
                la géométrie et l'analyse. Des exercices progressifs pour maîtriser le programme de
                terminale.
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t">
            ...
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">15-45</span> minutes par quiz
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">4.7★</span> Note moyenne
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">Accès</span> Immédiat
            </div>
          </div>
        </div>
      </div>
