          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                Testez vos connaissances avec 12 quiz interactifs couvrant l'algèbre, la géométrie
                et l'analyse. Des exercices progressifs pour maîtriser le programme de terminale
                scientifique.
              </p>
            </div>
