      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-8 sm:py-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                Découvrez 12 quiz interactifs soigneusement conçus pour maîtriser les mathématiques
                de terminale. Des fonctions exponentielles aux intégrales, testez vos connaissances
                et progressez efficacement.
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t">
            ...
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">4.9★</span> Note moyenne
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">Correction</span> Instantanée
            </div>
          </div>
        </div>
      </div>
